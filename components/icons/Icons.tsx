...
export const LocationMarkerIcon: React.FC<IconProps> = ({ className = "w-8 h-8" }) => (
...
export const DiscussionIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
...
export const ResetIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
     <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M15.322 15.322a8 8 0 11-10.644-10.644l1.06 1.06a6.5 6.5 0 109.193 9.193l-1.06-1.061zM10 2a8 8 0 100 16 8 8 0 000-16zm.5 10a.5.5 0 00-1 0v4a.5.5 0 001 0v-4zM10 5.5a.5.5 0 00-.5.5v2a.5.5 0 001 0v-2a.5.5 0 00-.5-.5z" clipRule="evenodd" />
    </svg>
);
